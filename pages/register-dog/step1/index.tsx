// pages/register-dog/step1/index.tsx (Step 1: Name Input)
  ...
  const handleSubmit = useCallback(() => {
    ...
    setTimeout(() => {
      try {
        ...
        navigation.reset({ index: 0, routes: [{ name: '/register-dog/step2' }] }); // Go to step 2
        
        // For now, let's go to home for testing
