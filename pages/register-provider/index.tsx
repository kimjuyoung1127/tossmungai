// pages/register-provider/index.tsx (Step 1: Name Input)
...
export const Route = createRoute('/register-provider', {
  component: RegisterProviderNameScreen,
});
...
function RegisterProviderNameScreen() {
  ...
  const handleSubmit = useCallback(() => {
    ...
    setTimeout(() => {
      try {
        ...
        // In a real app, you would pass the providerName to the next screen
        navigation.reset({ index: 0, routes: [{ name: '/register-provider-details' }] }); // Assuming next step
      ...
      <FixedBottomCTA.Double
        ...
        rightButton={
          <Button
            ...
            loading={isLoading}
            disabled={isLoading || !providerName}
          >
            다음
          </Button>
        }
...
export default RegisterProviderNameScreen;